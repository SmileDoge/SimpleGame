...
namespace SimpleGame.Render
{
    public class Camera
    {
        ...
        public void Controll(KeyboardState input, MouseState mouse, float dt)
        {
            var run = input.IsKeyDown(Keys.LeftShift);
            var oldSpeed = CameraSpeed;

            CameraSpeed = run ? CameraSpeed * 2 : CameraSpeed;
